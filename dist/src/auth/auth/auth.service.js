...
const user_read_dto_1 = require("../../users/dto/user-read.dto");
...
let AuthService = class AuthService {
    ...
    async login(readUserDto) {
        console.log('cou');
        const userFound = await this.us.findOne(readUserDto.email);
        if (!userFound) {
            throw new common_1.HttpException('User not found', common_1.HttpStatus.BAD_REQUEST);
        }
        const isPasswordMatching = await bcrypt.compare(readUserDto.password, userFound.password);
